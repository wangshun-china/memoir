...
use super::service::{
    create_memoir_with_chapters, get_memoir, list_chapters, list_memoirs, Chapter,
    CreateMemoirRequest, Memoir, MemoirWithChapters,
};
...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/memoirs/{memoir_id}", get(get_memoir_handler))
